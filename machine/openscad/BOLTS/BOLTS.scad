...
module DIN933(key="M3", l=20, part_mode="default"){
...
function DIN933_dims(key="M3", l=20, part_mode="default") = [
	...
	["key", key],
	["pitch", convert_to_default_unit(hexscrew1_table_0(key)[5],"mm")],
	["d1", convert_to_default_unit(hexscrew1_table_0(key)[0],"mm")]];

function DIN933_conn(location,key="M3", l=20, part_mode="default") = new_cs(
...
function tslot20x20_dims(l=10, detailed=false, part_mode="default") = [
	["l", l]];

module tslot20x20_1s(l=10, detailed=false, part_mode="default"){
	check_parameter_type("tslot20x20-1s","l",l,"Length (mm)");
	check_parameter_type("tslot20x20-1s","detailed",detailed,"Bool");

	if(BOLTS_MODE == "bom"){
		if(!(part_mode == "diff")){
			echo(str(" ","T"," ","slot"," ","extrusion"," ","one"," ","slot"," ","20x20x%s"," "));
		}
		cube();
	} else {
...
function tslot20x20_1s_dims(l=10, detailed=false, part_mode="default") = [
	["l", l]];

module tslot20x20_2s(l=10, detailed=false, part_mode="default"){
	check_parameter_type("tslot20x20-2s","l",l,"Length (mm)");
	check_parameter_type("tslot20x20-2s","detailed",detailed,"Bool");

	if(BOLTS_MODE == "bom"){
		if(!(part_mode == "diff")){
			echo(str(" ","T"," ","slot"," ","extrusion"," ","two"," ","slots"," ","(opp.)"," ","20x20x%s"," "));
		}
		cube();
	} else {
...
function tslot20x20_2s_dims(l=10, detailed=false, part_mode="default") = [
	["l", l]];

module tslot20x20_2sa(l=10, detailed=false, part_mode="default"){
	check_parameter_type("tslot20x20-2sa","l",l,"Length (mm)");
	check_parameter_type("tslot20x20-2sa","detailed",detailed,"Bool");

	if(BOLTS_MODE == "bom"){
		if(!(part_mode == "diff")){
			echo(str(" ","T"," ","slot"," ","extrusion"," ","two"," ","slots"," ","20x20x%s"," "));
		}
		cube();
	} else {
...
function tslot20x20_2sa_dims(l=10, detailed=false, part_mode="default") = [
	["l", l]];

module tslot20x20_3s(l=10, detailed=false, part_mode="default"){
	check_parameter_type("tslot20x20-3s","l",l,"Length (mm)");
	check_parameter_type("tslot20x20-3s","detailed",detailed,"Bool");

	if(BOLTS_MODE == "bom"){
		if(!(part_mode == "diff")){
			echo(str(" ","T"," ","slot"," ","extrusion"," ","three"," ","slots"," ","20x20x%s"," "));
		}
		cube();
	} else {
...
function tslot20x20_3s_dims(l=10, detailed=false, part_mode="default") = [
	["l", l]];
